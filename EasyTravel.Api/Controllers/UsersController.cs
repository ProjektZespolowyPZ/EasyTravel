...
using EasyTravel.Application.Users.Queries.GetOtherUserInformation;
...
namespace EasyTravel.Api.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        /// <summary>
        /// Returns general information about other user.
        /// </summary>
        /// <param name="id">User id</param>
        [HttpGet]
        [Route("GetOtherUserInformation/{id}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]

        public async Task<ActionResult<UserInformationVm>> GetOtherUserInformation(int id)
        {
            var vm = await Mediator.Send(new GetOtherUserInformationQuery() { UserId = id});
            return vm;
        }
